        ...
        <div className='h-12 w-full z-20 absolute top-0'>
            <div className='pl-4 justify-between flex z-20'>
                <ul className='flex gap-6 items-center'>
                    <li className='font-[400] primary-font uppercase text-xs' style={{letterSpacing: '2px'}}>yaariscore.me</li>
                    <li className='font-[400] primary-font uppercase text-xs' style={{letterSpacing: '2px'}}><Link to='/'>Home</Link></li>
                    <li className='font-[400] primary-font uppercase text-xs' style={{letterSpacing: '2px'}}><Link to='/store'>store</Link></li>
                    <li className='font-[400] primary-font uppercase text-xs' style={{letterSpacing: '2px'}}><Link to='/news'>news</Link></li>
                    <li className='font-[400] primary-font uppercase text-xs' style={{letterSpacing: '2px'}}><Link to='/share'>share</Link></li>
                    <li className='font-[400] primary-font uppercase text-xs' style={{letterSpacing: '2px'}}><Link to='/help'>help</Link></li>
                </ul>
                <ul className='flex gap-6 items-center'>
